...
\begin{function}{\dbsave, \dbsave*}
  ...
  \meta{data} stored by \cs{dbsave*} is not wrapped.
\end{function}
...
\begin{tblr}{
  ...
  2022-01-08 & 1.2.1 & Add macro: \cs{dbsave*} \\
  2022-01-08 & 1.2.2 & Fix bug of date conditional \\
\end{tblr}
